...
.style-r2 {
    ...
    <body>
        ...
        <div class="account_title bg" style="width: 1080px; margin-top: 20px; font-size: 12px;">Fatture Ricevute</div>
            ...
            <div class="act_as_table list_table" style="margin-top: 10px;">
                ...
                <div class="act_as_thead">
                    <div class="act_as_row labels">
                        ...
                        <div class="act_as_cell" style="width: 70px;">Numero registrazione</div>
                        ...
                        %for line in tax_lines(object) :
                            %if line['index']==0:
                              <div class="act_as_row lines">
                                  ...
                                  <div class="act_as_cell ${style}">${line['supplier_invoice_number'] or ''| entity}</div>
