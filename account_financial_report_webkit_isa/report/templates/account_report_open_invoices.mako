...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <% import addons %>        
    <% template1 = helper.get_mako_template('account_financial_report_webkit_isa','report', 'templates', 'open_invoices_inclusion.mako.html') %>
    <% context.lookup.put_template('open_invoices_inclusion.mako.html', template1) %>
    <% template2 = helper.get_mako_template('account_financial_report_webkit_isa','report', 'templates', 'grouped_by_curr_open_invoices_inclusion.mako.html') %>
