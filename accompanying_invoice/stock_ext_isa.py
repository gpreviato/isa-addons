...
class stock_picking_ext_isa(osv.osv):
    ...
    def action_invoice_create(self, cr, uid, ids, journal_id=False,
        ...
        if context.has_key('invoice_type') and context['invoice_type']=='accompanying':
            for inv_id in result:
                self.pool.get('account.invoice').write(cr, uid, result[inv_id], {'accompanying_invoice': True,}, context=context)
