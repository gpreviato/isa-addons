...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        %for account in get_accounts(data['context']):
            <%
                    ...
                    <div class="act_as_table list_table" style="margin-top: 10px;">
                        ...
                        <div class="act_as_thead">
                            <div class="act_as_row labels">
                                ...
                                <div class="act_as_cell" style="width: 70px;">Periodo</div>
                                <div class="act_as_cell" style="width: 70px;">Voce</div>
                                <div class="act_as_cell" style="width: 70px;">Sezionale</div>
                                <div class="act_as_cell" style="width: 60px;">Partner</div>
                                <div class="act_as_cell" style="width: 250px;">Etichetta</div>
                                <div class="act_as_cell" style="width: 60px;">Scadenza</div>
                                <div class="act_as_cell" style="width: 80px;">Riconc.</div>
                                <div class="act_as_cell amount" style="width: 80px;">Debito</div>
                                <div class="act_as_cell amount" style="width: 80px;">Credito</div>
                        ...
                        %for line in get_move_lines(move['id'],account['id']):
                            <%
                                if line.get('rec_name'):
                                    temp_move_blacklist.append(line['move_id'])

                                if line.get('move_originator'):
                                    temp_move_blacklist.append(line['move_originator'])
            ...
            %if not flag_account_header:
                <div class="act_as_table list_table" style="margin-top:5px;">
                    <div class="act_as_row labels" style="font-weight: bold; font-size: 12px;">
                            ...
                            <div class="act_as_cell" style="width: 390px;">Saldo Cumulativo su Conto</div>
                            <div class="act_as_cell amount" style="width: 80px;">${formatLang(temp_account_debit) | amount }</div>
                            <div class="act_as_cell amount" style="width: 80px;">${formatLang(temp_account_credit) | amount }</div>
