            ...
            if (context['partner_id']):
                ...
                if (t_partner_search):
                    t_partner_data = t_partner_obj.browse(cr, uid,
                                                          t_partner_search)[0]
                    if (t_partner_data
                            and t_partner_data.country_provenance
                            and t_partner_data.country_provenance.id):
            ...
            if (context['partner_id']):
                ...
                if (t_partner_search):
                    t_partner_data = t_partner_obj.browse(cr, uid,
                                                          t_partner_search)[0]
                    if (t_partner_data
                            and t_partner_data.country_origin
                            and t_partner_data.country_origin.id):
    ...
    def _default_province_destination(self, cr, uid, context=None):
        if ('company_id' in context
            ...
            if (context['company_id']):
                ...
                t_company_search = t_company_obj.search(cr, uid,
                                                        [('id', '=', t_company_id)])
                if (t_company_search):
                    t_company_data = t_company_obj.browse(cr, uid,
                                                          t_company_search)[0]
                    if (t_company_data
                            and t_company_data.province_destination
                            and t_company_data.province_destination.id):
            ...
            if (context['partner_id']):
                ...
                if (t_partner_search):
                    t_partner_data = t_partner_obj.browse(cr, uid,
                                                          t_partner_search)[0]
                    if (t_partner_data
                            and t_partner_data.way_of_freight
                            and t_partner_data.way_of_freight.id):
